...
if __name__ == "__main__":
    ...
    if args.job == 'train':
        if args.resume != 'default':
            ...
            if args.rbound == 1.:
                base_folder_name = '{}_{}_r{}_ep{}_search'.format(args.model, 'amc', args.preserve_ratio, args.train_episode)
            else:
                base_folder_name = '{}_{}_r{}_rbound{}_ep{}_search'.format(args.model, 'amc', args.preserve_ratio, args.rbound, args.train_episode)
