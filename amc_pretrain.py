...
def train(epoch, train_loader):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        loss = lam * criterion(outputs, targets) + (1 - lam) * criterion(outputs, targets[rand_index])
...
if __name__ == '__main__':
    ...
    if args.eval:  # just run eval
        ...
        log_dir = get_output_folder('./logs', '{}_{}_pretrain'.format(args.model, args.dataset))
